...
wget -q -O Mamaki.sh https://raw.githubusercontent.com/superneft1/Celestia/main/Mamaki.sh && chmod +x Mamaki.sh && sudo /bin/bash Mamaki.sh
```
...
wget -q -O Bridge_Node.sh https://raw.githubusercontent.com/superneft1/Celestia/main/Bridge_Node.sh && chmod +x Bridge_Node.sh && sudo /bin/bash Bridge_Node.sh
```
...
wget -q -O create-validator.sh https://raw.githubusercontent.com/superneft1/Celestia/main/create-validator.sh && chmod +x create-validator.sh && sudo /bin/bash create-validator.sh
```
